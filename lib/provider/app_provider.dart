...
import 'package:shoply/Firebase/firebase_storage_helper.dart';
...
class AppProvider with ChangeNotifier {
  ...
  void addFavourateProductList(ProductModel productModel) {
    ...
    FirebaseFirestoreHelper.instance
        .logUserFavoriteInteraction(productModel.id, true);
    notifyListeners();
  }
  ...
  void removeFavourateProductList(ProductModel productModel) {
    ...
    // FirebaseFirestoreHelper.instance
    //     .logUserFavoriteInteraction(productModel.id, false);
